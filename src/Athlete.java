...
//        symptomArray[21] = scan.nextInt();
    ...
    public void symptomSummary(){
        ...
        System.out.println("You have " + gameSymptoms.size() + " stored games. Which game do you want to see the summary for?");
        if (gameSymptoms.size() <5){
            System.out.println("Please select between 1 - " + gameSymptoms.size());
